...
const RELIGIOUS_PLACES = {
    ...
    'Ilya_Prorok': {
        ...
        video: { src: 'videos/Ilya_Prorok_bg.mp4', poster: 'stories_content/Ilya_Prorok/hram.png' },
    ...
    'Kreml': { // ← БЕЗ .html!
        ...
        video: { src: 'videos/kreml.mp4', poster: 'stories_content/Ilya_Prorok/kreml.png'  },
        paidEntry: null,
        photoButtons: [
